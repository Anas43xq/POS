...
public class TranslationDialogViewModel : BaseViewModel
{
        ...
        ILocalizationService? localizationService = null)
    {
        ...
        _localizationService = localizationService ?? App.ServiceProvider.GetRequiredService<ILocalizationService>();
    ...
    private async Task SaveAsync()
    {
        ...
        {
            ErrorMessage = _localizationService?.GetString("TranslationDialog.LanguageRequired") ?? "Please select a language.";
            return;
        }

        if (string.IsNullOrWhiteSpace(EditItem.TranslatedName))
        {
            ErrorMessage = _localizationService?.GetString("TranslationDialog.NameRequired") ?? "Translated name is required.";
            return;
        }
        ...
        {
            ErrorMessage = _localizationService?.GetString("TranslationDialog.SaveFailed", ex.Message) ?? $"Failed to save translation: {ex.Message}";
        }
    }
    ...
    private async Task DeleteAsync()
    {
        ...
        {
            ErrorMessage = _localizationService?.GetString("TranslationDialog.DeleteFailed", ex.Message) ?? $"Failed to delete translation: {ex.Message}";
        }
    }
}
