...
namespace UI.ViewModels
{
    public partial class ProductManagementViewModel : BaseViewModel
    {
        ...
        public bool IsCategorySearchEmpty => !string.IsNullOrWhiteSpace(CategorySearchText) && CategoryRoots.Count == 0;
        public bool IsProductSearchEmpty => !string.IsNullOrWhiteSpace(ProductSearchText) && Products.IsEmpty;
    ...
    public class ProductRowViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Compact display of the product's price(s): a single value for
        /// single-variant products, a "min–max" range for multi-variant
        /// ones, and a placeholder when the product has no active variants.
        /// </summary>
        public string PriceDisplay =>
            MinPrice is null
                ? "—"
                : (MinPrice == MaxPrice ? $"{MinPrice:N2}" : $"{MinPrice:N2} – {MaxPrice:N2}");
