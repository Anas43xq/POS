...
namespace UI.ViewModels
{
    public partial class ReportViewModel
    {
        ...
        // LoadReportAsync manages IsLoading; called by filter commands
        ...
        // Core data-loading; IsLoading managed by caller (e.g., OnReportAction for Load+Export span)
        ...
        {
            // Capture dialog/dates on STA UI thread before offloading CPU-bound work
            ...
            try
            {
                if (IsSalesMode)
                {
                    ...
                    // Offload export to background thread
                ...
                else if (IsSalesAnalysisMode)
                {
                    ...
                    {
                        StatusMessage = _localization.GetString("Manager.Reports.NoSalesAnalysisData");
                        return;
                    }
        ...
        private async Task OpenReceipt(TransactionReportDto? transaction)
        {
            if (transaction == null)
                return;
