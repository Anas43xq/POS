...
namespace UI.ViewModels
{
    public partial class HomeViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Loads dashboard data the first time the home page is shown;
        /// subsequent calls are no-ops unless RefreshCommand is used.
        /// </summary>
        public async Task EnsureDataLoadedAsync()
        {
            ...
            // Yield once so the manager shell can finish constructing and
            // show the initial frame before dashboard queries begin.
            await Task.Yield();
            await LoadAsyncSafe();
        }
