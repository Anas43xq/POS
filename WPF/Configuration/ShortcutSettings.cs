...
public sealed class CashierShortcuts
{
    ...
    public string CashPayment        => Get(nameof(CashPayment),        "F3");
    public string CardPayment        => Get(nameof(CardPayment),        "F4");
    public string ShowRecentSales    => Get(nameof(ShowRecentSales),    "F5");
    public string ReprintLastReceipt => Get(nameof(ReprintLastReceipt), "F6");
...
public sealed class ManagerShortcuts
{
    ...
    public string ModifierGroupManagement => Get(nameof(ModifierGroupManagement), "Alt+M");
