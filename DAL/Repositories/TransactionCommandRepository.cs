...
namespace DAL.Repositories
{
    public class TransactionCommandRepository : ITransactionCommandRepository
    {
        ...
        public TransactionCommandRepository(ISqlConnectionStringProvider connectionStringProvider)
        {
        ...
        public async Task<int> CreateTransactionAsync(CreateTransactionRequest request)
        {
            ...
            try
            {
                ...
                int transactionId = (int)(result ?? throw new InvalidOperationException("Transaction creation did not return an id."));
