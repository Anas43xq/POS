...
public static class DependencyInjection
{
    ...
    {
        services.AddSingleton<ISqlConnectionStringProvider>(
            new SqlConnectionStringProvider(connectionString));

        services.AddPooledDbContextFactory<PosDbContext>(options =>
        {
