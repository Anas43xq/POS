...
CREATE INDEX IX_Transactions_TransactionDate_Status ON dbo.Transactions(TransactionDate, Status);
CREATE INDEX IX_Transactions_ShiftId_CashierId_Status ON dbo.Transactions(ShiftId, CashierId, Status);
