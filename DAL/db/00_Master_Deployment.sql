...
:r .\DAL\db\Tables\dbo.RefreshTokens.Table.sql
GO
...
:r .\DAL\db\StoredProcedures\dbo.SP_LoginUser.StoredProcedure.sql
GO
...
:r .\DAL\db\StoredProcedures\dbo.SP_VoidTransaction.StoredProcedure.sql
GO
...
/* -------------------------------------------------
   ...
   seed scripts (including dbo.Modifiers.Seed.sql) in
   dependency order, so modifiers are seeded exactly once.
   ------------------------------------------------- */
:r .\DAL\db\seed.sql
GO
